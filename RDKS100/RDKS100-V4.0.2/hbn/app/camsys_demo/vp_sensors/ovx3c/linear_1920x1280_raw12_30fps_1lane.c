...
static mipi_config_t max96712_mipi_config = {
	.rx_enable = 1,
	.rx_attr = {
		.phy = 0, //D_PHY
		.lane = 4,
...
static camera_config_t ovx3cstd_camera_config = {
		...
		.extra_mode = 4,
		.config_index = 16896,
		// .mipi_cfg = &ovx3cstd_mipi_config, // MIPI配置,NULL自动获取
...
static vin_ichn_attr_t ovx3cstd_vin_ichn_attr = {
	.width =  SENSOR_WIDTH,
	.height = SENSOR_HEIGHT,
	.format = 0x2c,
};

static vin_attr_ex_t ovx3cstd_vin_attr_ex = {
	.cim_static_attr = {
		.water_level_mark = 0,
	},
};

static vin_ochn_attr_t ovx3cstd_vin_ochn_attr = {
	.ddr_en = 1,
	.vin_basic_attr = {
		.format = 0x2c,
		.wstride = 0,
...
static vin_node_attr_t ovx3cstd_vin_node_attr = {
	.vcon_attr = {
		.bus_main = 3,
		.bus_second = 3,
	},
...
static isp_attr_t ovx3cstd_gmsl_isp_attr = {
	.channel = {
		.hw_id = 0,
		.slot_id = 4,
...
static isp_ichn_attr_t ovx3cstd_gmsl_isp_ichn_attr = {
	.input_crop_cfg = {
		.enable = 0,
		.rect = {
			.x = 0,
...
static isp_ochn_attr_t ovx3cstd_gmsl_isp_ochn_attr = {
	.output_crop_cfg = {
		.enable = 0,
		.rect = {
			.x = 0,
...
static struct ynr_init_attr ovx3cstd_gmsl_ynr_attr = {
	.work_mode = 1,
	.slot_id = 4,
...
vp_sensor_config_t ovx3cstd_linear_1920x1280_raw12_30fps_1lane = {
	.chip_id_reg = 0,
	.chip_id = 0x0820,
	.sensor_i2c_addr_list = {0x10},
	.sensor_type = SENSOR_TYPE_GMSL_RAW,
	.sensor_name = "ovx3cstd-30fps",
	.config_file = "linear_1920x1280_yuv_30fps_1lane.c",
	.camera_config = &ovx3cstd_camera_config,
	.deserial_node_attr = &ovx3cstd_deserial_config,
	// .vin_attr = &ovx3cstd_vin_attr,
	.vin_ichn_attr = &ovx3cstd_vin_ichn_attr,
	.vin_node_attr = &ovx3cstd_vin_node_attr,
	.vin_attr_ex = &ovx3cstd_vin_attr_ex,
	.vin_ochn_attr = &ovx3cstd_vin_ochn_attr,

	.isp_attr      = &ovx3cstd_gmsl_isp_attr,
	.isp_ichn_attr = &ovx3cstd_gmsl_isp_ichn_attr,
	.isp_ochn_attr = &ovx3cstd_gmsl_isp_ochn_attr,
	.ynr_attr = &ovx3cstd_gmsl_ynr_attr,
};