...
static isp_attr_t ar0820std_isp_attr = {
	.channel = {
		.hw_id = 0,
		.slot_id = 4,
...
static isp_ichn_attr_t ar0820std_isp_ichn_attr = {
	.input_crop_cfg = {
		.enable = 0,
		.rect = {
			.x = 0,
...
static isp_ochn_attr_t ar0820std_isp_ochn_attr = {
	.output_crop_cfg = {
		.enable = 0,
		.rect = {
			.x = 0,
...
static struct ynr_init_attr ar0820std_ynr_attr = {
	.work_mode = 1,
	.slot_id = 4,
...
vp_sensor_config_t ar0820std_linear_3840x2160_30fps_1lane = {
	.chip_id_reg = 0,
	.chip_id = 0x0820,
	...
	.config_file = "linear_3840x2160_30fps_1lane.c",
	...
	.isp_attr      = &ar0820std_isp_attr,
	.isp_ichn_attr = &ar0820std_isp_ichn_attr,
	.isp_ochn_attr = &ar0820std_isp_ochn_attr,
	.ynr_attr = &ar0820std_ynr_attr,
};
