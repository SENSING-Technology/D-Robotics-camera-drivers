...
static deserial_config_t ar0233std_deserial_config = {
	.name = "max96712",
	.link_desp[0] = "ar0233std:2@512",
	.link_desp[1] = "ar0233std:2@512",
	.link_desp[2] = "ar0233std:2@512",
	.link_desp[3] = "ar0233std:2@512",
	.addr = 0x29,
...
static isp_attr_t ar0233std_isp_attr = {
	.channel = {
		.hw_id = 0,
		.slot_id = 4,
...
static isp_ichn_attr_t ar0233std_isp_ichn_attr = {
	.input_crop_cfg = {
		.enable = 0,
		.rect = {
			.x = 0,
...
static isp_ochn_attr_t ar0233std_isp_ochn_attr = {
	.output_crop_cfg = {
		.enable = 0,
		.rect = {
			.x = 0,
...
static struct ynr_init_attr ar0233std_ynr_attr = {
	.work_mode = 1,
	.slot_id = 4,
...
vp_sensor_config_t ar0233std_linear_1920x1080_30fps_1lane_trig = {
	.chip_id_reg = 0,
	.chip_id = 0x0231,
	...
	.sensor_name = "ar0233std-30fps",
	.config_file = "linear_1920x1080_30fps_1lane_trig.c",
	.camera_config = &ar0233std_camera_config,
	.deserial_node_attr = &ar0233std_deserial_config,
	// .vin_attr = &ar0233std_vin_attr,
