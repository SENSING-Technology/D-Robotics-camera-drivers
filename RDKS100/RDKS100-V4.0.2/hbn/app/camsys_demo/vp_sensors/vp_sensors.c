...
extern vp_sensor_config_t ox01fstd_linear_1280x960_30fps_1lane;
extern vp_sensor_config_t ar0231std_linear_1920x1080_30fps_1lane;

extern vp_sensor_config_t ar0233std_linear_1920x1080_30fps_1lane;
...
extern vp_sensor_config_t shw3h_shf3l_std_linear_1920x1536_60fps_1lane;

extern vp_sensor_config_t ar0820std_linear_3840x2160_30fps_1lane;

extern vp_sensor_config_t isx031_linear_1920x1536_yuv_30fps_1lane_left;
extern vp_sensor_config_t isx031_linear_1920x1536_yuv_30fps_1lane_right;

extern vp_sensor_config_t isx031std_linear_1920x1536_30fps_1lane_trig;
...
vp_sensor_config_t *vp_sensor_config_list[] = {
	...
	&ox01fstd_linear_1280x960_30fps_1lane,
	&ar0231std_linear_1920x1080_30fps_1lane,
	&ar0233std_linear_1920x1080_30fps_1lane,
	&isx031std_linear_1920x1536_30fps_1lane,
	&shw3h_shf3l_std_linear_1920x1536_30fps_1lane,
	&shw3h_shf3l_std_linear_1920x1536_60fps_1lane,
	&ar0820std_linear_3840x2160_30fps_1lane,
	&isx031_linear_1920x1536_yuv_30fps_1lane_left,
	&isx031_linear_1920x1536_yuv_30fps_1lane_right,
	&isx031std_linear_1920x1536_30fps_1lane_trig,
...
void vp_update_camera_config(const camera_config_t *camera_config_in, camera_config_t *camera_config_out, int link_port){
	...
	printf("addr: %#x ,serial_addr: %#x ,eeprom_addr : %#x\n", camera_config_out->addr,camera_config_out->serial_addr,camera_config_out->eeprom_addr);
}
...
int vp_get_isp_channel_config_for_single_pipeline(const int mipi_rx,
	...
	if(mipi_rx == 0){
		...
		if(is_online){
			ret = -1;
			printf("[ERROR] mipi_rx_%d unsupport online mode.\n", mipi_rx);
		}else{
