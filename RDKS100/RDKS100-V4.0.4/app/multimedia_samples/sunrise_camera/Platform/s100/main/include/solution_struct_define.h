...
typedef struct
{
	...
	ae_info_usr_t		st_auto;
//	me_info_t		st_manual;
}isp_exposure_info_usr_t;
...
typedef struct
{
	...
	isp_exposure_info_usr_t exposure;
}isp_usr_info_t;

typedef struct
{
	isp_usr_info_t		isp_info;
	venc_usr_infos_t	venc_info;
	aenc_info_t		aenc_info;
	adec_info_t		adec_info;
	osd_usr_info_t		osd_info;
